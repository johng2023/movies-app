...
async function displayPopularMovies() {
  const { results } = await fetchAPIData("movie/popular"); // curly braces destructures the object
...
async function displayPopularTVShows() {
  const { results } = await fetchAPIData("tv/popular"); // curly braces destructures the object

  console.log(results);

  results.forEach((result) => {
    const moviesContainer = document.querySelector("#popular-shows");
    const card = document.createElement("div");
    card.classList.add("card");
    card.innerHTML = `
  ...
  div.innerHTML = `
        <div class="details-top">
          ...
          <div>
            ...
            <p class="text-muted">Release Last Air Date: ${
              show.last_air_date
            }</p>
            <p>
              ${show.overview}
...
function addCommas(number) {
  // check stack overflow to find stuff like this
...
//Init App
//Simple router to put functions in for each page
